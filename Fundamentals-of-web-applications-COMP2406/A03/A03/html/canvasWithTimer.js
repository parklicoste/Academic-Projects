...
function handleJoinAsHomeButton(){
  ...
  let dataObj = {name: btn.value, color: 'red'}
  let jsonString = JSON.stringify(dataObj)
  socket.emit('added as home',jsonString)
...
function handleJoinAsVisitorButton(){
  ...
  let dataObj = {name: btn.value, color: 'yellow'}
  let jsonString = JSON.stringify(dataObj)
  socket.emit('added as visitor',jsonString)
...
function handleJoinAsSpectatorButton(){
  ...
  //btn.disabled = true //disable button
  //btn.style.backgroundColor="lightgray"
  //let dataObj = {name: btn.value, color: 'green'}
  //let jsonString = JSON.stringify(dataObj)
  socket.emit('added as spectator')
...
/*socket.on('added as spectator',function(){
  //let obj = JSON.parse(data)
  console.log('Joined as Spectator')
  //io.emit('added as spectator',data)
})//for join as spectator

socket.on('added as visitor',function(data){
  let obj = JSON.parse(data)
  console.log('Joined as Visitor' + data)
})// for join as visitor

socket.on('added as home',function(data){
  let obj = JSON.parse(data)
  console.log('Joined as Home' + data)

})//for adding a home

socket.on('moving stone', function(data){

})//synchronization movement for red and yellow
